...
# TOP_DOWN_MAP_COLORS[MAP_MP3D_WAYPOINT] = [255, 165, 0]  # Green
# TOP_DOWN_MAP_COLORS[MAP_VIEW_POINT_INDICATOR] = [245, 150, 150]  # Light Red
# TOP_DOWN_MAP_COLORS[MAP_TARGET_BOUNDING_BOX] = [255, 165, 0]  # Dark Green
# TOP_DOWN_MAP_COLORS[MAP_REFERENCE_POINT] = [0, 0, 0]  # Black
# TOP_DOWN_MAP_COLORS[MAP_MP3D_REFERENCE_PATH] = [255, 165, 0]  # Black
# TOP_DOWN_MAP_COLORS[MAP_WAYPOINT_PREDICTION] = [255, 255, 0]  # Yellow
# TOP_DOWN_MAP_COLORS[MAP_ORACLE_WAYPOINT] = [255, 165, 0]  # Orange
# TOP_DOWN_MAP_COLORS[MAP_SHORTEST_PATH_WAYPOINT] = [255, 165, 0]  # Dark Green
    ...
    for i, pt_to in enumerate(shortest_path_points):
        ...
        if i != 0:
            drawline(
                ...
                thickness=int(0.8 * map_resolution / MAP_THICKNESS_SCALAR),
                style="dashed",
                gap=10,
            )
        pt_from = pt_to
