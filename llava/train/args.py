...
class TrainingArguments(transformers.TrainingArguments):
    ...
    use_lasar_injection: bool = field(
        default=False,
        metadata={"help": "Enable [MAP] token + cognitive-map injection (MindCraft/QA only when has_query is set)."},
    )
    tune_lasar_modules: bool = field(
        default=False,
        metadata={"help": "Train LASAR cognitive-map modules. Keep False until auxiliary losses are enabled."},
    )
